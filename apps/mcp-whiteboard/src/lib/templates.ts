/**
 * Whiteboard Templates for MCP Server
 * Predefined templates that agents can apply to the whiteboard
 */
...
const c4ContextTemplate: WhiteboardTemplate = {
  id: 'c4-context',
...
// ERD Template
const erdTemplate: WhiteboardTemplate = {
  id: 'erd',
...
const sprintBoardTemplate: WhiteboardTemplate = {
  id: 'sprint-board',
  name: 'Sprint Board',
...
// Flowchart Template
const flowchartTemplate: WhiteboardTemplate = {
  id: 'flowchart',
  name: 'Flowchart',
...
const userStoryMapTemplate: WhiteboardTemplate = {
  id: 'user-story-map',
  name: 'User Story Map',
...
const sequenceDiagramTemplate: WhiteboardTemplate = {
  id: 'sequence-diagram',
...
// Template ID to template map
export const TEMPLATE_MAP: Record<string, WhiteboardTemplate> = {
  'c4-context': c4ContextTemplate,
  'erd': erdTemplate,
  'sprint-board': sprintBoardTemplate,
  'flowchart': flowchartTemplate,
  'user-story-map': userStoryMapTemplate,
  'sequence-diagram': sequenceDiagramTemplate,
};
...
// Clone template elements with new IDs and offset
